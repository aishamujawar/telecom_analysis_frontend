...
import 'package:carousel_slider/carousel_controller.dart'; // Correct import
...
class _ChurnAnalysisPageState extends State<ChurnAnalysisPage> {
  String churnCountsImageUrl = "http://10.118.52.240:5001/get_churn_counts_image";
  String missingValuesImageUrl = "http://10.118.52.240:5001/get_missing_values_plot";
  List<String> countplotImageUrls = [];
  String monthlyVsTotalChargesImageUrl = "http://10.118.52.240:5001/get_monthly_vs_total_charges";
  String monthlyChargesKdeUrl = "http://10.118.52.240:5001/get_monthly_charges_kde";
  String totalChargesKdeUrl = "http://10.118.52.240:5001/get_total_charges_kde";
  String churnCorrelationBarUrl = "http://10.118.52.240:5001/get_churn_correlation_bar";
  String correlationHeatmapUrl = "http://10.118.52.240:5001/get_correlation_heatmap";
  String genderForChurnedUrl = "http://10.118.52.240:5001/get_distribution_of_gender_for_churned_customers";
  String genderForNonChurnedUrl = "http://10.118.52.240:5001/get_distribution_of_gender_for_non_churned_customers";
  String paymentMethodForChurnedUrl = "http://10.118.52.240:5001/get_distribution_of_paymentmethod_for_churned_customers";
  String contractForChurnedUrl = "http://10.118.52.240:5001/get_distribution_of_contract_for_churned_customers";
  String techSupportForChurnedUrl = "http://10.118.52.240:5001/get_distribution_of_techsupport_for_churned_customers";
  String seniorCitizenForChurnedUrl = "http://10.118.52.240:5001/get_distribution_of_seniorcitizen_for_churned_customers";
  String distributionTenureByChurnUrl = "http://10.118.52.240:5001/get_distribution_tenure_by_churn";
  String distributionMonthlyChargesByChurnUrl = "http://10.118.52.240:5001/get_distribution_monthlycharges_by_churn";
  String distributionTotalChargesByChurnUrl = "http://10.118.52.240:5001/get_distribution_totalcharges_by_churn";
  String customerSegmentationImageUrl = "http://10.118.52.240:5001/get_customer_segmentation_by_contract_tenure";
  String featureImportanceImageUrl = "http://10.118.52.240:5001/get_feature_importance_random_forest";
  String customerClustersImageUrl = "http://10.118.52.240:5001/get_customer_clusters_plot";
  ...
  Future<void> fetchCountplotImages() async {
    ...
    for (var predictor in predictors) {
      final response = await http.get(Uri.parse("http://10.118.52.240:5001/get_countplot/$predictor"));
      if (!mounted) return;
      if (response.statusCode == 200) {
        setState(() {
          countplotImageUrls.add("http://10.118.52.240:5001/get_countplot/$predictor");
        });
      }
    }
  }
        ...
        child: Column(
          children: [
            ...
            MasonryGridView.count(
              ...
              itemCount: 10, // Number of standalone images
